            ...
            <div class="mt-16">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                        <div>
                            ...
                            <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">Posts count </h2>

                            <p class="mt-4 text-gray-500 dark:text-gray-400 text-lg leading-relaxed">
                                {{$page.props.postsCount}}
                            </p>
                        </div>

                        <div>
                            <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">Comments count </h2>

                            <p class="mt-4 text-gray-500 dark:text-gray-400 text-lg leading-relaxed">
                                {{$page.props.commentCount}}
                            </p>
                        </div>
